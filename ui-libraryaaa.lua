                ...
                if opened == false then
                    ...
                    for i,v in pairs(Data.Dropdowns) do
                        if v.Type == "Toggle" then
                            ...
                            local corner1 = Instance.new("UICorner",slidebar)
                            local corner2 = Instance.new("UICorner",slideball)
                            slideball.Size = UDim2.new(0.7,0,1.3,0)
                            slideball.AnchorPoint = Vector2.new(0.5,0.5)
                            slideball.Position = UDim2.new(0,0,0.5,0)
                            corner1.CornerRadius = UDim.new(90,90)
                            corner2.CornerRadius = UDim.new(999,999)
